...
<div class="container mx-auto max-w-5xl px-4 py-12 md:py-20">
  ...
  <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
    ...
    <!-- Insight 2: Monetization Safety Guide -->
    <a 
  ...
  <!-- CTA Section -->
  <div class="mt-16 rounded-lg bg-surface p-8 text-center md:p-12">
    ...
    <a 
      href="/how-it-works" 
      class="inline-flex items-center gap-2 rounded-lg bg-accent-primary px-6 py-3 font-medium text-background transition-colors hover:bg-accent-primary/90"
    >
      How It Works
      <span aria-hidden="true">→</span>
    </a>
